 ...
 */
 ...
 import { TextInput, StyleSheet, Text, NativeModules, ScrollView } from 'react-native';

 const { OnscreenShell } = NativeModules;
 export default class App extends Component {
   ...
   onPressEnter() {
     ...
     OnscreenShell.executeCommand(command, (result) => {
       this.setState({
         result: result
       });
     });
